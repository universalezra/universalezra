class BioVAuth {
    constructor() {
        ...
        this.elements = {
            ...
            ezraText: document.getElementById('ezraText') // Added this line
        };
        this.securityConfig = {
            maxAttempts: 3,
    ...
    setupEventListeners() {
        ...
        this.elements.ezraText.addEventListener('click', () => this.toggleFullscreen()); // Added this line
    }
